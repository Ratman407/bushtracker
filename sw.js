const CACHE='bushtrack-v061-cache';
const KEEP=['bushtrack-v061-cache','bushtrack-v06-cache','bushtrack-v05-cache','bushtrack-v04-fallback-cache','bushtrack-v04-cache'];
const FILES=['./','./index.html','./style-v06.css','./style-v061.css','./app-v06.js','./hotfix-v061.js','./manifest.webmanifest','./version.json','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./fallback-v05.html','./style-v05.css','./app-v05.js','./fallback-v04.html','./style-v04.css','./app-v04.js'];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.endsWith('/app-v06.js')){
    event.respondWith(Promise.all([textFrom('./app-v06.js'),textFrom('./hotfix-v061.js')]).then(parts=>new Response(parts.join('\n\n'),{headers:{'Content-Type':'application/javascript; charset=utf-8','Cache-Control':'no-store'}})));
    return;
  }
