/* BushTrack V0.7.0 update handling: automatic banner disabled; manual check only. */
(function(){
  if(window.BushTrack070UpdateFix)return;
  ...
  window.BushTrack070UpdateFix={killBanner,manualCheck};
})();